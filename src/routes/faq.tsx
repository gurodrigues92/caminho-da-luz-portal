...
const faqData = [
  ...
  { question: "Onde ficam as casas do Caminho da Luz?", answer: "Temos casas em Sorocaba/SP (sede principal), São Paulo/SP, Recife/PE e Itararé/SP. Cada casa possui seu próprio calendário de trabalhos." },
