...
function WhatsAppFAB() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-cdl-secondary shadow-lg hover:scale-110 transition-all duration-300 md:hidden"
      aria-label="Fale conosco no WhatsApp"
    >
      <svg viewBox="0 0 24 24" className="h-7 w-7 fill-cdl-bg-dark">
