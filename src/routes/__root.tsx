...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Centro Espiritual Universalista de Santo Daime. Casas em Sorocaba, São Paulo, Pernambuco e Itararé." },
      ...
      { property: "og:description", content: "Centro Espiritual Universalista de Santo Daime. Casas em Sorocaba, São Paulo, Pernambuco e Itararé." },
      { name: "twitter:description", content: "Centro Espiritual Universalista de Santo Daime. Casas em Sorocaba, São Paulo, Pernambuco e Itararé." },
    ...
    links: [
      ...
      },
      {
        ...
        as: "font",
        type: "font/woff2",
        href: "https://fonts.gstatic.com/s/sourcesans3/v19/nwpStKy2OAdR1K-IwhWudF-R3w8aZejf5Hc.woff2",
        crossOrigin: "anonymous",
      },
      {
        rel: "preload",
        as: "font",
        type: "font/woff2",
        href: "https://fonts.gstatic.com/s/josefinsans/v34/Qw3aZQNVED7rKGKxtqIqX5EUDXx4Vn8sig.woff2",
        crossOrigin: "anonymous",
      },
    ],
    scripts: [
      ...
      {
        children:
          "(function(){var l=document.querySelector('link[rel=\"preload\"][as=\"style\"][href*=\"fonts.googleapis.com\"]');if(l){l.rel='stylesheet';l.removeAttribute('as');}})();",
      },
    ],
  }),
